...
ENV RUNTIME_CONFIG_KEYS=VITE_API_BASE_URL,VITE_SUPABASE_URL,VITE_SUPABASE_ANON_KEY,VITE_WEB_BRAND_NAME,VITE_BROWSER_BRAND_NAME,VITE_TELEGRAM_BOT_URL,VITE_SUPPORT_TELEGRAM_URL,VITE_TELEGRAM_WEB_APP_FALLBACK_URL
